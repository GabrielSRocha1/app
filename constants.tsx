...
export const CATEGORIES: Record<string, { icon: React.ReactNode; color: string; label: string }> = {
...
export const EXPENSE_CATEGORIES: Category[] = [
  ...
  'Lazer e Hobbies', 'Cuidados Pessoais', 'Dízimo e Oferta', 'Roupas', 'Transporte', 'Presentes e Doações'
];

export const PAYMENT_METHODS: PaymentMethod[] = [
  'Boleto', 'Pix', 'Dinheiro', 'Cartão de Crédito', 'Cartão de Débito'
];

export const BANKS: string[] = [
  'Nubank', 'Itaú', 'Inter', 'Santander', 'Bradesco', 'Caixa'
];
